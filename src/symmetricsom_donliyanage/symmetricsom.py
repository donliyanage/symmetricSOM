...
def Features(dsFEATURESET, dsLABEL, nDimentions, nRows = 30, nCols = 30, nLearnMax = 0.5, nStepsMax = 175000, fSAVESOM = True, nSAVESOM = "SOM_MAP.DAT", nSAVESOMLABEL = "SOM_LABEL.DAT"):
